...
async function viewTrades() {
 ...
 WHEN r.pool_address = '0x51e883ba7c0b566a26cbc8a94cd33eb0abd418a77cc1e60ad22fd9b1f29cd2ab' THEN 'DEEP/SUI'
 WHEN r.pool_address = '0xe01243f37f712ef87e556afb9b1d03d0fae13f96d324ec912daffc339dfdcbd2' THEN 'WAL/SUI'
 ELSE r.pool_address
END as pool_name,
        r.*,
